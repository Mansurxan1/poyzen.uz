...
const Last24HoursProducts = () => {
  ...
  if (!last24HourVariants.length) {
    return (
      <div className="p-4 text-center text-gray-500">
        {t("new_arrivals")} (Son 24 soat ichida yangi mahsulotlar yo'q)
      </div>
    )
  }
  ...
  return (
    <section className="w-full px-4 py-8">
      <h2 className="text-xl font-bold mb-4 text-center">{t("new_arrivals")} (Son 24 soat)</h2>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className={`absolute top-2 right-2 rounded-full p-2 shadow z-10 ${
                    likedProducts[item.id] ? "bg-white border-none" : "bg-black border border-black"
                  }`}
                >
                ...
                <div className="flex flex-col text-sm text-gray-600">
                  <p>
                    ...
                    <span className="line-through text-red-400">
                      {formatPrice(item.price)} {currency.toUpperCase()}
                    </span>
                  </p>
                  <p>
                    {t("discount")}:{" "}
                    <span className="font-bold text-green-600">
                      {formatPrice(item.discount)} {currency.toUpperCase()}
                    </span>
                  </p>
